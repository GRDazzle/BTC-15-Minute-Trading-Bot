...
def extract_features(
    ...
    Args:
        ...
        spike_signal: Unused, kept for API compat.
        tickvel_signal: Unused, kept for API compat.
        decision_minute: dm value (0-9) within the 15-min window.
        window_open_price: Price at minute 0 of the window.
        btc_velocity_60s: Unused, kept for API compat.
    """
